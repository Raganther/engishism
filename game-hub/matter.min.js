/* ================= 2D physics engine (vendored) =================
   ...
   The physics substrate behind hub-table.js (Kit.table) — answer pieces as
   boxes you flick around a space and drop into slots. Loaded before hub-table.js
   so window.Matter exists when that shelf destructures it. Sits beside hub-qr.js
   as a vendored, offline, no-build dependency.
   ========================================================================== */
/*!
