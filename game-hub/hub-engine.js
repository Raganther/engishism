...
(function(){
  ...
  /* Its own two buttons, filed with their own game — they sat at the bottom of the
     Race block once, which is exactly the kind of misfiling that makes a later
     extraction look like it needs more than it does. */
