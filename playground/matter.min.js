/* ================= 2D physics engine (vendored) =================
   Matter.js 0.19.0 — @liabru (Liam Brummitt) — MIT licence.
   ...
   for this header, so it can be replaced by dropping in a newer build/matter.min.js.
   The UMD wrapper sets window.Matter when loaded as a plain script.

   Used by throw-lab.html — the physics substrate for the throw dynamic (answer
   pieces as boxes you flick around a space). Lives in playground/ for now, the
   same isolation the lab-only question forms have: playground-only until the
   dynamic earns its place in the hub, at which point it moves beside hub-qr.js.
   ========================================================================== */
/*!
