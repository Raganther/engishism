...
process.stdin.on('end', () => {
  ...
  const note = [
    ...
    '  · a rule that will constrain the next piece of work — an axiom, stated as a rule',
    '  · a contract that changed, or something now on a shelf',
    '  · a new registry, or a new place a thing lives',
    '  · anything the Open section now describes wrongly, or an item that just closed',
    '',
    'There is NO history in CLAUDE.md — no fixed bugs, no suite counts, no "we built X".',
    'That is what this commit message is for: the subject says what changed, the body',
    'says why and what proved it. git log is the history. If a lesson is general it is',
    'an axiom; if it is not worth an axiom it is not worth keeping.',
    '',
