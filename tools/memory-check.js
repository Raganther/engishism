...
process.stdin.on('end', () => {
  ...
  const note = [
    ...
    'Update it in this commit if the change involved any of —',
    '  · a decision, or a decision reversed, and why',
    '  · a bug whose cause is not obvious from the fix',
    '  · something now on a shelf, or a contract that changed',
