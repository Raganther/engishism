    ...
    sentenceBuilders: [
      {
        ...
        clue: 'Build a present continuous question.',
        words: ['What', 'are', 'you', 'doing', '?'],
        answer: ['What', 'are', 'you', 'doing', '?'],
        sentence: 'What are you doing?',
        explanation: 'Question order: are + subject + verb-ing.',
      },
      {
        id: 'she-is-taking-picture',
        clue: 'Build a sentence about an action happening now.',
        words: ['is', 'a', 'taking', 'picture', 'She', '.'],
        answer: ['She', 'is', 'taking', 'a', 'picture', '.'],
        sentence: 'She is taking a picture.',
        explanation: 'Use is + verb-ing for she.',
      },
      {
        id: 'they-are-not-listening',
        clue: 'Build a negative present continuous sentence.',
        words: ['listening', 'not', 'They', 'are', '.'],
        answer: ['They', 'are', 'not', 'listening', '.'],
        sentence: 'They are not listening.',
        explanation: 'Negative form: are + not + verb-ing.',
      },
      {
        id: 'he-is-tying-shoelace',
        clue: 'Build a sentence about what he is doing now.',
        words: ['shoelace', 'tying', 'his', 'is', 'He', '.'],
        answer: ['He', 'is', 'tying', 'his', 'shoelace', '.'],
        sentence: 'He is tying his shoelace.',
        explanation: 'Use is + tying for he.',
      },
      {
        id: 'english-is-improving',
        clue: 'Build a sentence about a change in progress.',
        words: ['English', 'is', 'improving', 'My', '.'],
        answer: ['My', 'English', 'is', 'improving', '.'],
        sentence: 'My English is improving.',
        explanation: 'Present continuous can describe a change that is happening now.',
      },
      {
        id: 'are-they-waiting',
        clue: 'Build a yes/no question.',
        words: ['waiting', 'they', 'Are', '?'],
        answer: ['Are', 'they', 'waiting', '?'],
        sentence: 'Are they waiting?',
        explanation: 'Question order: are + subject + verb-ing.',
      },
    ],
    speakingPrompts: [
